...
stringFSM xs =
  mkFSM [0..n] xs [(x,(xs !! x),x+1) | x <- [0..n-1]] [0] [n]
  where n = length xs

emptyFSM :: FSM Int
emptyFSM = mkFSM [0,1] [] [] [0] [0]
...
simpleFSMbh = mkFSM qs as ts ss fs
 where
   qs = [Q0,Q1,Q2,Q3]
   as = [a,b,c,d]
   ts = [(Q0,b,Q3),(Q0,c,Q3),(Q0,d,Q3),(Q1,a,Q3),(Q2,a,Q3),(Q2,b,Q3),(Q2,c,Q3),(Q2,d,Q3),
      (Q3,a,Q3),(Q3,b,Q3),(Q3,c,Q3),(Q3,d,Q3),(Q0,a,Q1),(Q1,b,Q1),(Q1,c,Q2),(Q1,d,Q2)]
   ss = [Q0]
   fs = [Q2]
...
muWords = mkFSM [0..8] as
  [(0,c,1),(0,l,1),(0,t,1),(1,a,4),(1,o,5),(1,i,6),(2,a,4),(2,o,5),(3,a,4),(3,o,5),(3,i,6),
  (4,p,7),(5,p,7),(6,p,7),(4,t,7),(5,t,7),(6,t,7)] 
  [0] [7,8]
  where as@[a,o,i,c,l,t,p]="abcdeghiot" -- edit this as required
...
eg5i = mkFSM
       [0..5]
       "ab"
       [(0,a,1),(1,b,3),(3,b,4),(5,a,1),(5,b,3),(4,a,5)]
       [0]
       [4]
...
eg5ii = mkFSM
       [0..5]
       "ab"
       [(0,a,1),(1,b,3),(3,b,4),(1,a,5),(5,b,3),(4,a,5)]
       [0]
       [4]
...
eg5iii = mkFSM
       [0..5]
       "ab"
       [(0,a,1),(1,b,3),(3,b,4),(5,a,1),(5,a,3),(4,a,5)]
       [0]
       [1,4]
...
eg5v = mkFSM
       [0..5]
       "ab"
       [(0,a,1),(1,b,3),(3,b,4),(5,b,1),(5,a,3),(4,a,5),(4,b,4)]
       [0]
       [1]
...
eg5vi = mkFSM
       [0..5]
       "ab"
       [(0,b,1),(1,a,3),(3,b,4),(5,a,1),(4,a,5),(4,b,4)]
       [0]
       [1]
...
reverseFSM (FSM qs as ts ss fs) =
  mkFSM qs as (reversed ts) fs ss
  where reversed trans = map (\(x,y,z) -> (z,y,x)) trans

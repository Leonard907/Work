...
public class BookEntry {
    ...
    public static final String NULL_NAME = "Book name cannot be null.";
    /** Exception message for authors array null. */
    public static final String NULL_AUTHORS = "Author array cannot be null.";
    /** Exception message for author name null. */
    public static final String NULL_AUTHOR = "Author name cannot be null";
    /** Exception message for invalid book rating. */
    public static final String INVALID_RATING = "Rating must be in range 0~5.";
    /** Exception message for ISBN code null. */
    public static final String NULL_ISBN = "ISBN code cannot be null.";
    /** Exception message for invalid page number. */
    public static final String INVALID_PAGES = "Pages cannot be negative.";
